...
namespace qb8s.net.OptiFit.Persistence.Migrations
{
    ...
    [Migration("20250302202541_remove gym_exercise_mapping")]
    partial class removegym_exercise_mapping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("qb8s.net.OptiFit.Core.Entities.ExerciseCategory", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_exercise_group");

                    b.HasIndex("I18NCode")
                        .IsUnique()
                        .HasDatabaseName("ix_exercise_group_i18n_code");

                    b.ToTable("exercise_group", (string)null);
            ...
            modelBuilder.Entity("qb8s.net.OptiFit.Core.Entities.WorkoutSet", b =>
                {
                    b.HasOne("qb8s.net.OptiFit.Core.Entities.WorkoutExercise", null)
