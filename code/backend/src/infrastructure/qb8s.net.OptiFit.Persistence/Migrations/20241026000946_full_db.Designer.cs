...
namespace qb8s.net.OptiFit.Persistence.Migrations
{
    ...
    [Migration("20241026000946_full_db")]
            ...
            modelBuilder.Entity("qb8s.net.OptiFit.Core.Entities.WorkoutPlanExerciseMapping", b =>
                {
                    ...
                    b.HasIndex("ExerciseId1")
                        .HasDatabaseName("ix_workout_plan_exercise_mapping_exercise_id1");
            ...
            modelBuilder.Entity("qb8s.net.OptiFit.Core.Entities.Workout", b =>
                {
                    b.HasOne("qb8s.net.OptiFit.Core.Entities.Gym", "Gym")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_workout_gyms_gym_id");
                    ...
                    b.HasOne("qb8s.net.OptiFit.Core.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_workout_users_user_id");
            ...
            modelBuilder.Entity("qb8s.net.OptiFit.Core.Entities.WorkoutLog", b =>
                {
                    ...
                    b.HasOne("qb8s.net.OptiFit.Core.Entities.Workout", "Workout")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_workout_log_workout_workout_id");
            ...
            modelBuilder.Entity("qb8s.net.OptiFit.Core.Entities.WorkoutPlanExerciseMapping", b =>
                {
                    ...
                    b.HasOne("qb8s.net.OptiFit.Core.Entities.Exercise", null)
                        .WithMany("WorkoutPlanExerciseMappings")
                        .HasForeignKey("ExerciseId1")
                        .HasConstraintName("fk_workout_plan_exercise_mapping_exercise_exercise_id1");
