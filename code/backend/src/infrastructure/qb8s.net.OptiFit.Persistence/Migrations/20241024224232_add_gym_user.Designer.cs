...
namespace qb8s.net.OptiFit.Persistence.Migrations
{
    ...
    [Migration("20241024224232_add_gym_user")]
    partial class add_gym_user
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("qb8s.net.OptiFit.Core.Entities.Gym", b =>
                {
                    ...
                    b.HasIndex("CreatedById")
                        .HasDatabaseName("ix_gym_created_by_id");
            ...
            modelBuilder.Entity("qb8s.net.OptiFit.Core.Entities.Gym", b =>
                {
                    b.HasOne("qb8s.net.OptiFit.Core.Entities.User", "CreatedBy")
                        .WithMany("Gyms")
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_gym_users_created_by_id");
